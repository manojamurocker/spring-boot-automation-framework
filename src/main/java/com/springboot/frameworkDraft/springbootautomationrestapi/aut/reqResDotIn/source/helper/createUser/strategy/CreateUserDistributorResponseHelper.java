...
public class CreateUserDistributorResponseHelper extends CreateUserStrategy{
    /**
     *
     */
    @Override
    public void verifyResponse() {
        ...
        Assert.assertNotNull("Verified for user distributor", "user as distributor");
        LogService.Assertion("Verified for user distributor");
    }
}
